...
| `x`-prefixed pages (`xindex.astro`, `xemployer.astro`, `x1index.astro`, …), `*-BACKUP`, `*-OLD-*`, `_backup/` | ~100 legacy/stale route files identified as dead in `docs/engineering/MARKETING-WEBSITE-ENGINEERING-REPORT.md` (L768, L806). **Note:** Astro routes every file in `src/pages/`, so these remain publicly reachable and still carry claims — see *Legacy files* below |
...
**Route abbreviations used below:** `/ic/*` = `/imaging-center/*`, `/blog/*` = individual blog posts.
...
| "the $90+ billion imaging market" | `src/pages/imaging-center/model.astro:86` | /ic/model | N |
...
| "delivered $240 Million+ in volume" | `src/pages/imaging-center/index.astro:148, 325, 420, 704, 1229` | /ic/ | N |
| "$240M+ volume delivered" | `src/pages/imaging-center/index.astro:63, 187, 619, 1279` | /ic/ | N |
...
| "90 million uninsured and underinsured patients" | `src/pages/imaging-center/index.astro:159, 1295` | /ic/ | N |
...
| "400,000+ patient visits generated for partners" | `src/pages/imaging-center/index.astro:360, 415, 532, 1018` | /ic/ | N |
| "managed 400,000+ appointments" | `src/pages/imaging-center/index.astro:956` | /ic/ | N |
...
| "access to 50,000+ self-pay patients" | `src/pages/imaging-center/calculator.astro:19, 263` | /ic/calculator | N |
...
| "$11,250" / "$135,000" (calculator revenue projection) | `src/pages/imaging-center/calculator.astro:228, 234, 240` | /ic/calculator | N |
...
| "1,236%" growth rate / Inc. 500 | `src/pages/about.astro:1148`, `src/pages/imaging-center/experience.astro:138, 508, 514` | /about, /ic/experience | N |
...
| "recruited 1,200+ imaging centers (1994-2002)" | `src/pages/imaging-center/index.astro:63, 148, 176, 248, 323, 410, 470, 690, 698, 769, 833, 895, 1073, 1090, 1109, 1158, 1174, 1229, 1274` | /ic/ | N |
| "growing from concept to 1,200+ centers" | `src/pages/imaging-center/experience.astro:116, 128, 196, 542, 549, 646` | /ic/experience | N |
...
| "$600" / "USRad Rate" (calculator max) | `src/pages/imaging-center/calculator.astro:97` | /ic/calculator | N |
...
| "$300" / "Guaranteed payment per scan" | `src/pages/imaging-center/calculator.astro:103, 131, 311, 347, 364` | /ic/calculator | N |
...
| "~$195" (net per scan after costs) | `src/pages/imaging-center/calculator.astro:328` | /ic/calculator | N |
...
| "100% payment collection" / "100% collection rate" | `src/pages/imaging-center/index.astro:610, 619, 1229`, `src/pages/imaging-center/calculator.astro:32, 351`, `src/components/provider/priority-markets/MarketStats.astro:47` | /ic/, /ic/calculator, /provider | N |
...
| "96% patient show rate" / "Proven 96% success rate" / "96% approval rate" | `src/pages/imaging-center/index.astro:277, 378, 576, 786, 850, 1229` | /ic/ | N |
...
| "~85%" (utilization assumption) | `src/pages/imaging-center/calculator.astro:214, 315` | /ic/calculator | N |
...
| **"65%"** / "Average Unfilled Appointment Slots" | `src/components/imaging/NetworkMap.astro:33` | /ic/ | N |
...
| "typically see 20-40% volume increases" | `src/pages/imaging-center/index.astro:265, 525, 1036, 1192`, `src/components/provider/FAQSection.astro:96` | /ic/, /provider | N |
...
| **"35%"** / "Typical Slot Utilization" | `src/components/provider/priority-markets/MarketStats.astro:21`, `src/components/imaging/NetworkMap.astro:28` | /provider, /ic/ | N |
...
| "30-70% below hospital rates" / "30-70% less" | `src/pages/imaging-center/model.astro:356, 480` | /ic/model | N |
...
| "Submit network credentialing application (15 minutes)" | `src/pages/imaging-center/implementation.astro:273` | /ic/implementation | N |
| "Complete our online application (5 minutes)" | `src/pages/imaging-center/faq.astro:255` | /ic/faq | N |
...
| **"payment within 15 days"** | `src/pages/imaging-center/benefits.astro:191`, `src/pages/imaging-center/faq.astro:536, 690`, `src/pages/imaging-center/index.astro:610`, `src/pages/imaging-center/model.astro:765` | /ic/benefits, /ic/faq, /ic/, /ic/model | N |
...
| "successful for 8 years" | `src/pages/imaging-center/index.astro:569` | /ic/ | N |
| "(1994-2002)" | `src/pages/imaging-center/index.astro:63, 323, 375` | /ic/ | N |
...
| "No-show rates … typically less than 5%" | `src/pages/imaging-center/faq.astro:838` | /ic/faq | N |
...
| **"2-3 weeks"** (credentialing / time to first patient) | `src/components/provider/FAQSection.astro:45, 63`, `src/components/provider/HowItWorks.astro:239`, `src/pages/provider/portal-tour.astro:214, 402, 1094, 1141`, `src/pages/provider-how-it-works-1.astro:181, 359, 1135, 1172`, `src/pages/provider/consultation.astro:129`, `src/pages/imaging-center/index.astro:769, 778, 1065, 1174`, `src/pages/imaging-center/faq.astro:267`, `src/pages/imaging-center/implementation.astro:173, 871` | /provider, /provider/portal-tour, /provider-how-it-works-1, /provider/consultation, /ic/, /ic/faq, /ic/implementation | N |
| "2-3 business days" (application review) | `src/pages/imaging-center/index.astro:850` | /ic/ | N |
...
| "Typically less than 2 minute wait time" | `src/pages/imaging-center/support.astro:334` | /ic/support | N |
| "Email support with responses within 2 hours" | `src/pages/imaging-center/faq.astro:1053`, `src/pages/imaging-center/support.astro:282, 460, 861` | /ic/faq, /ic/support | N |
...
| "We'll get back to you within 24 hours" | `src/components/ProviderConsultationForm.astro:238`, `src/pages/provider/consultation.astro:58, 156`, `src/components/provider/ExitModal.astro:238, 384`, `src/pages/imaging-center/calculator.astro:569` | /provider/consultation, /provider, /ic/calculator | N |
...
| "24/7 technical assistance" / "24/7 network support" | `src/pages/imaging-center/benefits.astro:865`, `src/pages/imaging-center/implementation.astro:429, 630`, `src/pages/imaging-center/faq.astro:1052`, `src/pages/imaging-center/model.astro:234` | /ic/benefits, /ic/implementation, /ic/faq, /ic/model | N |
...
| "3-5 days" (results) | `src/pages/blog/mri-basics.astro:1109`, `src/pages/imaging-center/index.astro:1053` | /blog/mri-basics, /ic/ | N |
...
| "Acquired by CorVel Corporation (NYSE: CVL)" | `src/pages/imaging-center/index.astro:63` | /ic/ | N |
...
| "created and scaled the first nationwide imaging network of its kind" | `src/pages/imaging-center/experience.astro:116` | /ic/experience | N |
...
| "launched first transparent pricing model in diagnostic imaging" / "First Mover" | `src/pages/imaging-center/experience.astro:438, 444` | /ic/experience | N |
...
| "Join our nationwide network of premium imaging centers" | `src/components/Footer.astro:114` | **11 /ic/ + /news pages** | **Y (11)** |
...
| "Inc. 500 Fastest Growing" / "#210" | `src/pages/co-founder-m.astro:363, 364`, `src/pages/imaging-center/experience.astro:215` | /co-founder-m, /ic/experience | N |
...
| "Scaled to 400+ imaging centers nationwide" (1990s milestone) | `src/pages/imaging-center/experience.astro:474` | /ic/experience | N |
| "Applying proven methodology to serve 90+ million" | `src/pages/imaging-center/experience.astro:578` | /ic/experience | N |
| "Coming Summer 2025: Advanced analytics platform" | `src/pages/imaging-center/benefits.astro:694`, `src/pages/imaging-center/faq.astro:910`, `src/pages/imaging-center/implementation.astro:505` | /ic/benefits, /ic/faq, /ic/implementation | N |
| "Providers joining … before December 2025 receive priority access" | `src/pages/imaging-center/benefits.astro:821` | /ic/benefits | N |
| "The partner portal (coming Fall 2025)" | `src/pages/imaging-center/faq.astro:980` | /ic/faq | N |
...
| **400,000+** | `imaging-center/index.astro:360, 415, 532, 1018, 956` — "patient visits" / "appointments" | /ic/ |
...
| **$240 Million+** | "in volume" / "in revenue" | `imaging-center/index.astro:63, 148, 187, 325, 420, 619, 704, 1229, 1279` | /ic/ |
...
| "Acquired by CorVel Corporation (**NYSE: CVL**)" | `imaging-center/index.astro:63` | /ic/ |

One exchange listing and ticker is wrong. The `/ic/` variant conflicts with the sitewide footer.
...
| **$300** | `imaging-center/calculator.astro:103, 131, 311, 347, 364` (guaranteed payment to center) | /ic/calculator |
...
| **1,200+** | AnciCare historical network | ~40 locations | /, /about, /provider, /ic/*, /investor, /employer |
...
| **15 days** "guaranteed" | `imaging-center/benefits.astro:191`, `imaging-center/faq.astro:536, 690`, `imaging-center/index.astro:610`, `imaging-center/model.astro:765` | /ic/ funnel |
...
| **35%** "Typical Slot Utilization" / **65%** "Average Unfilled Appointment Slots" | `imaging/NetworkMap.astro:28, 33` | /ic/ |
...
| Value | Location | Page |
| --- | --- | --- |
| **2–3 weeks** | 18 locations across `/provider`, `/provider/portal-tour`, `/provider-how-it-works-1`, `/provider/consultation`, `/ic/`, `/ic/faq`, `/ic/implementation` | provider + imaging-center funnels |
...
| **5 minutes** / **15 minutes** | `imaging-center/faq.astro:255`, `imaging-center/implementation.astro:273` | /ic/faq, /ic/implementation |
...
| **30–70%** | `imaging-center/model.astro:356, 480` | /ic/model |
...
| Value | Location | Page |
| --- | --- | --- |
| **96% show rate** | `provider/FAQSection.astro:369, 379`, `provider/GuaranteeSection.astro:62`, `provider/ScannerUtilization.astro:414`, `provider/faq.astro:2721`, `built-usrad.astro:339`, `imaging-center/index.astro` (6 locations) | /provider, /provider/faq, /built-usrad, /ic/ |
| **no-show rate below 5%** (implies ≤95% show) | `provider/faq.astro:1825` | **/provider/faq** |
| **No-show rates … less than 5%** | `imaging-center/faq.astro:838` | /ic/faq |
...
| Value | Location | Page |
| --- | --- | --- |
| **20-40% volume increases** | `provider/FAQSection.astro:96`; `imaging-center/index.astro:265, 525, 1036, 1192` | **/provider**, /ic/ |
...
| Value | Location | Page |
| --- | --- | --- |
| **1994-2002** (8 years) | `imaging-center/index.astro:63, 323, 375` | /ic/ |
| **"successful for 8 years"** | `imaging-center/index.astro:569` | /ic/ |
...
| **`src/components/Footer.astro`** | **11** | • "Join our **nationwide** network of premium imaging centers" (L114) | **11 pages** — /ic/apply, /ic/benefits, /ic/calculator, /ic/coming-soon, /ic/experience, /ic/faq, /ic/implementation, /ic/, /ic/model, /ic/support, /news |
...
| "1,200+ centers" | **~40** | across `/`, `/about`, `/provider`, `/ic/`, `/ic/experience`, `/investor`, `/employer`, `/provider/portal-tour` |
...
| "2–3 weeks credentialing" | **18** | across `/provider`, `/provider/portal-tour`, `/provider-how-it-works-1`, `/provider/consultation`, `/ic/`, `/ic/faq`, `/ic/implementation` |
...
| **400,000+ "patient visits" / "appointments"** | /ic/ | encounters — 2.4× the patient figure |

"168,224 MRIs Performed" is the outlier: it converts a *people* count into a *procedure*
count at 1:1, while `/ic/` separately claims 400,000+ visits for the same network.
...
| "$300" / "Guaranteed payment per scan", "~$45/scan" + "~$25/scan" costs → "~$195" net | gross and net broken out | `imaging-center/calculator.astro:103, 319, 323, 328` | /ic/calculator |
...
sibling page's gross rate. `/ic/calculator` puts the same center's net at ~$195.
...
| Claim | Location | Page |
| --- | --- | --- |
| "**Coming Summer 2025**: Advanced analytics platform" | `imaging-center/benefits.astro:694`, `imaging-center/implementation.astro:505` | /ic/benefits, /ic/implementation |
| "Web-based portal access (**coming Summer 2025**)" | `imaging-center/faq.astro:910` | /ic/faq |
| "The partner portal (**coming Fall 2025**)" | `imaging-center/faq.astro:980` | /ic/faq |
| "Providers joining … **before December 2025** receive priority access" | `imaging-center/benefits.astro:821` | /ic/benefits |
...
## Legacy files (out of scope, still route-reachable)

Astro creates a route for every file in `src/pages/`. The ~100 `x`-prefixed files are documented
as stale in the engineering reports but are **not** excluded from the build and remain publicly
reachable. Several carry claims that contradict the live site:

| Legacy route | Claim | Conflicts with |
| --- | --- | --- |
| `/xhow-it-works-ab` | "served **168,224** patients, and saved **$246 million**" (L531, L610) | C1 |
| `/education/xwhat-is-an-mri` | "Served **400,000+** patients • **$400 Million+** savings delivered" (L38, L248, L813, L903) | C1, C2 — this is the only place `$400 Million+` appears outside the orphaned `FoundersSection` |
| `/x2unimarket`, `/x3unicorn`, `/x1index`, `/xemployer-carbon3` | "$3,200" hospital MRI | U1 |

`docs/engineering/MARKETING-WEBSITE-ENGINEERING-REPORT.md` L743 already flags these as an SEO
and indexing risk (no `robots.txt`). They are also a claims-consistency risk.
