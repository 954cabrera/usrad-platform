...
Branch: `workstream-a-marketing` · Current HEAD: `f82430c` · Rollback for whole workstream: `b86e06e`
Origin: `f82430c` — pushed 2026-08-10, fast-forward `1f2d9b5..f82430c`. **Branch and origin are level; nothing unpushed.** `main` at `be2dd14`, unchanged since July 30.
...
| **AnciCareLegacy** | ⛔ **OMITTED FROM THE SEQUENCE ABOVE — added 2026-08-10, DOC-18.** Its own short corrective batch. See below and open item #49 |
