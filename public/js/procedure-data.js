 ...
 * 
 * 1. src/lib/procedures/data/procedure-data.js  ← SOURCE OF TRUTH (edit there!)
 * 2. public/js/procedure-data.js                 ← YOU ARE HERE (runtime copy)
 * 
 * 🚨 DO NOT EDIT THIS FILE DIRECTLY! 🚨
 * -------------------------------------
 * This is a COPY for browser runtime access.
 * All changes should be made in the source file, then copied here.
 * 
 * WHY THIS COPY EXISTS:
 * --------------------
 * • This file is served directly to browsers at runtime
 * • Enables window.ProcedureLibrary for legacy code
 * • Required for HeroSection popular procedures dropdown
 * • Cannot import from src/ folder in browser
 * 
 ...
 *    - Click search box to test popular procedures
 * 
 * 4. Commit BOTH files:
 ...
 * 
 * ⚠️  IF YOU EDIT THIS FILE DIRECTLY:
 * ----------------------------------
 * • Changes will be LOST on next update
 * • TypeScript build will use old data from src/
 * • Search results won't match popular procedures
 * • Creates inconsistent behavior
 * • Confusion for other developers
 * 
 * 🔗 FILES THAT USE THIS:
 * ----------------------
 * • HeroSection.astro (line ~12) - Browser import for window.ProcedureLibrary
 * • Inline search script - Accesses window.ProcedureLibrary.Popular
 * 
 * 🔗 FILES THAT USE THE SOURCE (src/lib/):
 * ---------------------------------------
 ...
 * =======================================
 * Complete CPT reference - Browser runtime copy
 * 
 * Last Updated: [Date of last copy from source]
