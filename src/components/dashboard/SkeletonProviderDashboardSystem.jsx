          ...
          <div className="usrad-card p-8 animate-fade-in-up" style={{animationDelay: '0.7s'}}>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">Revenue Opportunities</p>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4 hover:shadow-md transition-all duration-300">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-900" style={{fontFamily: 'Manrope, sans-serif'}}>
                        Cash-Pay Patients
                      </h4>
                      <p className="text-sm text-gray-600 mt-1">90M+ uninsured/underinsured</p>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-200 rounded-xl p-4 hover:shadow-md transition-all duration-300 cursor-pointer">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-1">$30B+ annual market</p>
                      <div className="flex items-center mt-2 space-x-4">
                        <div className="flex items-center space-x-1">
                          <Clock className="w-3 h-3 text-blue-600" />
                          <span className="text-xs font-semibold text-blue-700">Coming Soon</span>
                        </div>
                        <span className="text-xs text-gray-500">ETA: Q1 2026</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 opacity-75">
                <div className="flex items-start justify-between">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-gray-700" style={{fontFamily: 'Manrope, sans-serif'}}>
                        Health Insurance & Managed Care
                      </h4>
                      <p className="text-sm text-gray-600 mt-1">Major carrier networks including Auto</p>
                      <div className="flex items-center mt-2 space-x-4">
                        <div className="flex items-center space-x-1">
                          <div className="w-2 h-2 bg-gray-400 rounded-full"></div>
                          <span className="text-xs font-semibold text-gray-600">Planned</span>
                        </div>
                        <span className="text-xs text-gray-500">Target: 2027</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-green-600" style={{fontFamily: 'Manrope, sans-serif'}}>1</div>
                  <div className="text-xs text-gray-600">Active Market</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-blue-600" style={{fontFamily: 'Manrope, sans-serif'}}>2</div>
                  <div className="text-xs text-gray-600">In Development</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-gray-900" style={{fontFamily: 'Manrope, sans-serif'}}>90M+</div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold text-gray-900" style={{fontFamily: 'Manrope, sans-serif'}}>
                    Network Expansion - Growing
                  </p>
                  <p className="text-xs text-gray-600 mt-0.5">
                    Your center gains access to new markets as USRad expands
                  </p>
                </div>
              </div>
            </div>
